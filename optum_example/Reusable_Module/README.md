...
| <a name="input_node_pool_node_count"></a> [node\_pool\_node\_count](#input\_node\_pool\_node\_count) | (Optional) The number of nodes which should exist in this Node Pool. Defaults based on environment. | `number` | `1` | no |
